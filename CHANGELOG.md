...
- Scoped recall-quality report through `Deja.recallReport()` and `deja eval`.
...
- Rebuilt Deja as a local-first SQLite + FTS5 agent memory with slips, handoffs, and MCP.
