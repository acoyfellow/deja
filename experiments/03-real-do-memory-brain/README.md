...
database and a global write lock satisfies Deja's shared-memory contract
...
If yes, the eventual Deja deployment on Cloudflare can stay shaped exactly
...
This experiment → eventual Deja shape:

| this experiment                              | eventual Deja                                 |
| -------------------------------------------- | --------------------------------------------- |
