...
wrangler whoami
wrangler deploy
REMOTE_URL=https://deja-exp09-deployed-live-mirror-feed.<subdomain>.workers.dev \
  ./remote-harness.sh
wrangler delete --name deja-exp09-deployed-live-mirror-feed --force
```

The disposable Workers.dev endpoint is unauthenticated experiment code. Delete it
after measurement. Product shared Deja must have authentication and connection
authorization.
