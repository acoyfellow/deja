...
- worker: `deja-exp05-deployed-do-memory-brain`
- URL: `https://deja-exp05-deployed-do-memory-brain.cloudflare-support-chat.workers.dev`
...
```text
Successfully deleted deja-exp05-deployed-do-memory-brain
```

A follow-up `wrangler deployments status --name deja-exp05-deployed-do-memory-brain`
...
disposable experiment endpoint; it is **not** acceptable for shared Deja itself.
